...
- Exploratory data analysis: Number of samples per condition, gene expression distribution per sample, correlogram, PCA.
- Differential expression analysis using `edgeR` and `DESeq2`. Make the heatmap and the volcano plot of differentially expressed genes.
...
- Compare lists of differentially expressed genes obtained after two different pipelines and the functional enrichment analysis results. Use a Venn diagram and consider the up- and downregulated directionality of changes. Describe the discrepancies. 

...
- **Gene set enrichment analysis** - summarizing enrichment of **genes** of interest, such as differentially expressed genes, in **gene annotations** (molecular functions, canonical pathways)

\bigskip

- **Epigenomic enrichment analysis** - summarizing enrichment of **genomic regions** of interest, such as disease-associated genomic variants, in **genome annotations** (chromatin states, transcription factor binding sites)

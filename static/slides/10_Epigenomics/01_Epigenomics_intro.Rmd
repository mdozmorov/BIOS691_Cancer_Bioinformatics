...
- Functionally, these elements can be subdivided into three categories:
    1. **Enhancers**, which provide an activating influence on transcription.

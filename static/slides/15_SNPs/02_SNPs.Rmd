...
```{=tex}
\begin{center}
\includegraphics[height=110px]{img/number_of_snps.png}
\end{center}
```
...
\tiny https://www.internationalgenome.org/about/
...
\tiny https://www.genome.gov/10001688/international-hapmap-project
...
```{=tex}
\begin{center}
\includegraphics[height=90px]{img/exacv2_barplot_cut.png}
\end{center}
```
\tiny http://exac.broadinstitute.org/, http://gnomad.broadinstitute.org/, https://macarthurlab.org/2017/02/27/the-genome-aggregation-database-gnomad/
...
\end{center}
```
<https://github.com/brentp/vcfanno> <https://genomebiology.biomedcentral.com/articles/10.1186/s13059-016-0973-5>

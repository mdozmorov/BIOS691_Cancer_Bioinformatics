...
## save and load
dataDir <- "/Users/mdozmorov/Documents/Data/Teaching/BIOS691.2021"
saveDb(txdb, file=file.path(dataDir, "/hg19_knownGenes.sqlite")) # Takes a few minutes
txdb=loadDb(file.path(dataDir, "/hg19_knownGenes.sqlite"))
txdb

---
title: "Array-based methylation technologies and analysis"
...
- **DMAP** (P. Stockwell et al.) RRBS fragment or fixed window approach, Fisher’s exact test, Chi-squared or ANOVA RADMeth (C++ command-line tool by E. Dolzhenko and A.D. Smith) Beta-binomial regression analysis to find DMCs or DMRs, local likelihood, adjust for neighboring CpGs http://biochem.otago.ac.nz/research/databases-software
...
- **methylKit** (A. Akalin et al.) Sliding window, Fisher’s exact test, or logistic regression. Adjusts p-values to q-values using the SLIM method. https://github.com/al2na/methylKit
...
3) Chemical treatment with bisulfite (BS)

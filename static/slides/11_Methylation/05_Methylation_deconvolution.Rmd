...
- Expression Deconvolution
    ...
    - There is also a vector that contains the cell subset of the mixture in the signature matrix

## Modeling Cell Mixtures

Mixtures (X) are a linear combination of the signature matrix (S) and concentration matrix (C)
...
- Using CIBERSORT to enumerate cell proportions based on support vector regression
...
- Obviously, other tissues can be affected. See Guintivano (2013) Epigenetics for the brain.
-->
...
- If required, it can be combined with batch-correction methods such as COMBAT
...
| Name           | Description                                                           | Programming language | Weblinks                                      |
|----------------|-----------------------------------------------------------------------|:--------------------:|------------------------------------------------|
